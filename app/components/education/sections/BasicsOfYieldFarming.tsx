					...
					<Section title="How Kamo Makes it Better">
						...
						<ul className="mt-4 space-y-2">
							<li className="flex items-center gap-2">
								...
								<span>
									Principal Token (PT) - This is your main investment. It's like
									a savings account that gives you back your original amount.
								</span>
							</li>
							<li className="flex items-center gap-2">
								<span className="text-primary">•</span>
								<span>
									Yield Token (YT) - This represents your future rewards. It's
									like having a claim on all the interest you'll earn.
								</span>
							</li>
						</ul>
					</Section>
