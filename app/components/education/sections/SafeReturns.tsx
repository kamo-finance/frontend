	...
	return (
		<div className="space-y-8">
				...
				<div className="space-y-8">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<div className="p-6 bg-primary/10 rounded-lg">
							...
							<p className="text-foreground/80">
								Know exactly how much you'll get back at maturity. Your returns
								are locked in.
							</p>
						</div>
						<div className="p-6 bg-primary/10 rounded-lg">
						...
						<div className="space-y-6">
							...
							<div className="space-y-4">
								...
								<div className="p-6 bg-primary/10 rounded-lg">
									...
									<p className="text-foreground/80">
										If PT's fixed rate is better than your prediction, it's a
										good time to buy.
									</p>
								</div>
							</div>
							...
							<div className="p-6 border border-primary/20 rounded-lg bg-primary/5">
								...
								<p className="text-foreground/80">
									...
									6.4% fixed rate, that's a good deal! You'll earn more than
									expected.
								</p>
							</div>
						</div>
			...
			<Section title="Selling PT Early">
				<div className="space-y-6">
					<p className="text-foreground/80">
						You don't have to wait until maturity. You can sell PT anytime for
						profit.
					</p>
					...
					<div className="p-6 border border-primary/20 rounded-lg bg-primary/5">
						...
						<p className="text-foreground/80">
							...
							that's often the best time to buy. You can lock in high rates and
							not worry about market ups and downs.
						</p>
					</div>
				</div>
			</Section>
