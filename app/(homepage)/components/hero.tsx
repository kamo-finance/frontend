...
export const Hero = () => {
	...
	return (
		<section className="relative min-h-screen flex items-center overflow-hidden">
			...
			<MotionDiv
				className="absolute bottom-20 right-10 w-72 h-72 rounded-full mix-blend-multiply filter blur-xl opacity-70"
				animate={{
					scale: [1, 1.2, 1],
					opacity: [0.5, 0.7, 0.5],
				}}
				...
				>
					...
					<div className="space-y-8">
						...
						<MotionDiv variants={fadeInUp} className="flex gap-4">
							{[
								{ href: "/markets", color: "primary", text: "Launch App", variant: undefined },
								{ href: "/docs", color: "secondary", text: "Learn More", variant: "bordered" }
							].map((btn, index) => (
