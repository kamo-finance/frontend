...
export const MarketContent = ({ marketId, marketInfo }: MarketContentProps) => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 h-[calc(150vh-80px)] md:h-[calc(100vh-80px)]">
      ...
      <div
        ref={rightSideRef}
        className="lg:col-span-7 overflow-y-auto pr-0 md:pr-4 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]"
      >
