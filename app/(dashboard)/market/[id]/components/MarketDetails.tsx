...
const MarketDetails: React.FC<MarketDetailsProps> = ({ marketInfo }) => {
		...
		<div className="space-y-6">
			...
			<div className="rounded-xl p-6">
				<div className="flex items-center gap-3 mb-6">
					<Image src="/images/kusdc.png" alt="kUSDC" width={40} height={40} />
					<div>
				...
				<div className="grid grid-cols-2 gap-6">
					...
					<div>
						...
						<div className="text-2xl font-bold text-gray-900">19/05/2025</div>
					</div>
				</div>
			</div>
