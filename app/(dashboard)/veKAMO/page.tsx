...
import { FaLock, FaVoteYea, FaChartLine } from "react-icons/fa";
    ...
    <div className="flex flex-col gap-6 rounded-3xl bg-foreground-100 p-6 mb-8 border-3 border-foreground">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-foreground-500">
          Lock your KAMO to receive veKAMO and participate in protocol
          governance. Longer lock periods result in higher voting power and
          rewards.
        </p>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {stats.map((stat, index) => (
          <div
            key={index}
            className={`bg-foreground-200 rounded-2xl p-4 border-3 border-foreground`}
          >
    ...
    <div className="space-y-6 relative pb-24">
      ...
      <div className="rounded-3xl shadow-sm p-6 border-3 border-foreground bg-foreground-100">
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-600">
          ...
          <li>
            Entitle you to earn a share of the pool&apos;s swap fees,
            proportional to your votes
          </li>
        </ol>
      ...
      <div className="fixed bottom-0 right-0 left-0  border-t border-gray-200 p-4 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <Button color="primary" disabled={remainingVotes !== 0}>
            {remainingVotes === 0
              ? "Submit Votes"
...
const OngoingVotesChart = () => {
  const data = {
    labels: ["kUSDC Pool", "haSUI Pool", "USDT/KAMO Pool", "Others"],
    datasets: [
      {
