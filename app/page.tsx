...
const faqs = [
  {
    ...
    answer: "Kamo is a DeFi protocol that enables users to maximize their yield through innovative tokenization and trading strategies."
  },
  {
    question: "What is veKAMO?",
    answer: "veKAMO is our governance token that allows holders to participate in protocol decisions and earn additional rewards."
  },
  {
    question: "What are the expected returns?",
    answer: "You can earn up to 15% APY through our staking strategies, with additional benefits for veKAMO holders."
  }
];
    ...
    <main className="flex flex-col min-h-screen">
      ...
      <section className="py-20 bg-blue-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-blue-900 mb-16">Kamo Ecosystem</h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-blue-900 mb-16">FAQs</h2>
