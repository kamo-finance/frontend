...
const TokenSwapInput: React.FC<TokenSwapInput> = ({
	...
	<div className={`bg-foreground-100 rounded-3xl border-3 border-foreground p-4 ${className}`}>
		<div className="text-lg text-foreground font-semibold mb-2">{title}</div>
...
const TradeWidget: React.FC<TradeWidgetProps> = ({ marketId }) => {
	...
	return (
		<>
			<div className="rounded-3xl shadow-sm p-6 flex flex-col gap-4">
				<TokenBalances
